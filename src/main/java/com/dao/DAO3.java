...
public class DAO3 {
	...
	public List<Product> getAllProduct() {
		List<Product> listv = new ArrayList<Product>();
...
//				v.setPimage(rs.getString(6));
				...
				v.setPprice(rs.getInt(3));
				v.setPquantity(rs.getInt(4));
				v.setPimage(rs.getString(5));
				v.setBid(rs.getInt(6));
				v.setCid(rs.getInt(7));
				v.setProdDesc(rs.getString(8));
				listv.add(v);
...
//				product.setProdDesc(rs.getString("description"));
